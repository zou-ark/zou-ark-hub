...
const notes = {
  ...
  classic: ['1.0 方案目录', '<p>已整理的方向包括：原画战斗、纯战斗、泰克头资源显示，以及特定地图的除水设置。</p><p><strong>新增画质：</strong>黑地基+A镜画质，适用于 1.0 战斗画质配置。</p><p><a href="downloads/ark-1.0-black-foundation-a-scope.txt" download>下载 黑地基+A镜画质</a></p><p>使用前请备份原始配置；游戏更新后如有异常，请恢复备份并重新确认参数。</p>'],
