(() => {
  ...
  const entries = [
    ...
    { category: '画质代码', kind: 'QUALITY DOCS', title: '1.0 战斗画质文档', count: '8 篇文档 + 1 个下载', description: '除树、原画战斗、人物视角、除水面、战斗画质目录，以及新增黑地基+A镜画质。', action: 'open', assets: [
      ['A 镜除树画质', 'https://www.feishu.cn/docx/KnGidV7e9od7W6xuVHgcP1q2ndE', '飞书文档'], ['Zou 直播用原画战斗', 'https://www.feishu.cn/docx/L9T6d7IFuost9nxmV7ncEMN1nBd', '飞书文档'], ['人物视角设置', 'https://www.feishu.cn/docx/UCEzdQNsNoAUNXxuBbccAl5anzk', '飞书文档'], ['单除水面', 'https://www.feishu.cn/docx/VHtzdyGm5obDGLxofOvcQGM9nig', '飞书文档'], ['战斗画质 2', 'https://www.feishu.cn/docx/N7mndG95Yoq4VuxqdXNcKO5Wn4b', '飞书文档'], ['无特效画质', 'https://www.feishu.cn/docx/F7yZdk6wZoHCyyxSmVFcF8j3nDe', '飞书文档'], ['炮塔 / 盾牌 / 变色方法', 'https://www.feishu.cn/docx/LxLSd8pr9otGsXxlMBGclVGjnig', '飞书文档'], ['画质更改目录', 'https://www.feishu.cn/docx/QaZRd86SyodHVJx5RZ4cSqyEnZd', '飞书文档'], ['黑地基+A镜画质', 'downloads/ark-1.0-black-foundation-a-scope.txt', 'TXT · 新增']
    ]},
    ...
    { category: '教学', kind: 'INSTALL GUIDE', title: '1.0 双语汉化教学', count: '安装说明 + 补丁', description: '提供物品双语补丁和放置位置说明；下载后按说明安装，覆盖前请自行备份原文件。', action: 'open', protected: true, assets: [['双语汉化安装说明', 'downloads/ark-bilingual-install.txt', 'TXT'], ['下载 ShooterGame-Windows_Z6.1 物品双语补丁', 'downloads/patches/ShooterGame-Windows_Z6.1物品双语.pak', 'PAK · 28.6MB']] },
    ...
    { category: 'Zou 工具箱', kind: 'WINDOWS APP', title: '方舟版本快速切换', count: '358 ⇄ 361 内测版', description: '用于《ARK: Survival Evolved》（ASE）Steam 分支版本的快速切换与双槽位管理；首次使用需联系抖音 Zou走走（VX：Hiizou）完成设备激活。', action: 'open', protected: true, assets: [['下载方舟版本快速切换', './tools/ark-version-switch/方舟版本快速切换.exe', 'EXE · 89KB'], ['粉丝客户使用说明', './tools/ark-version-switch/使用说明.txt', 'TXT'], ['SHA256 文件校验', './tools/ark-version-switch/SHA256校验.txt', 'TXT']] }
  ];
